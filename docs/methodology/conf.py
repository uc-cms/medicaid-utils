...
htmlhelp_basename = 'medicaid_utilsdoc'
...
latex_documents = [
    (master_doc, 'medicaid_utils.tex', 'medicaid\\_utils Documentation',
     'Research Computing Group, Biostatistics Laboratory, The University of Chicago', 'manual'),
]
